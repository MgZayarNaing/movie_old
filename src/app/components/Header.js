      ...
      <nav className="bg-white border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            ...
            <Link href="/login" className="text-sm text-gray-500 hover:text-gray-700 ml-4 border border-gray-950 px-5  text-justify">
              Sign In
            </Link>
            <Link href="/register" className="text-sm text-gray-500 hover:text-gray-700 ml-4">
              Sign Up
            </Link>
